...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        System.out.println("ageOfCar: " +  ageOfCar);
         ...
         if (ageOfCar <=10) {
             salePrice-= (0.05 * ageOfCar * salePrice);
         }
         else{
             salePrice-= (0.1*salePrice);
         }
    ...
    public static void main(String[] args) {
        ...
        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2021, 60000.0, 2, true, false, true, false, false, true);
    }
}
